[gosrsbox/osrsboxapi](https://godoc.org/github.com/atye/gosrsbox/osrsboxapi) is a client library for [osrsbox-api](https://api.osrsbox.com) utilizing OpenAPI automation.
# Installing
