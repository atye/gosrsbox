...
func Test_HttpUpdateMonsters(t *testing.T) {
	type checkFn func(t *testing.T, items []db.Monster, expectedNames []string, err error)
	verifyItemNames := func(t *testing.T, monsters []db.Monster, expectedNames []string, err error) {
		if err != nil {
			t.Errorf("expected no error, got %v", err)
		}
...
func Test_HttpUpdatePrayers(t *testing.T) {
	type checkFn func(t *testing.T, items []db.Prayer, expectedNames []string, err error)
	verifyItemNames := func(t *testing.T, prayers []db.Prayer, expectedNames []string, err error) {
		if err != nil {
			t.Errorf("expected no error, got %v", err)
		}
